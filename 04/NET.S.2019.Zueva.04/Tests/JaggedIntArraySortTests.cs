...
namespace Tests
{
    ...
    public class JaggedIntArraySortTests
    {
        ...
        {
            int[][] arrayToSort = new int[][] {  new int[]{1, 4, 5, 8 },
                                        new int[]{3, 5, 4 ,3, 2, 6},
                                        new int[] {89, 3, 2,1, -1 } };
            int[][] expectedResult = new int[][] {  new int[]{1, 4, 5, 8 },
                                        new int[]{3, 5, 4 ,3, 2, 6},
                                        new int[] {89, 3, 2,1, -1 } };
        ...
        {
            int[][] arrayToSort = new int[][] { new int[] {43,32,13, 100, 12 },
                                        new int[] {23,2, 5, 1000, 15},
                                        new int[] {0,22,1}};
            int[][] expectedResult = new int[][] { new int[] {0,22,1},
